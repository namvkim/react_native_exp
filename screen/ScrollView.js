...
export default function Sc_View() {
    const DATA = [
        {
            id: 1,
            isSelected: false,
            ...
            timeAllowance: 'N/A',
            laha: 'N/A',
            description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Et amet, elementum augue velit orci risus cras. Pretium tortor condimentum.',
                ...
                </View>
                {
                    data.map((item, index) => (
                        <View key={index} style={styles.item}>
                            <TouchableOpacity onPress={() => onRowPress(item)} style={[styles.itemRow, { borderBottomColor: '#E8E8EB', borderBottomWidth: 1, paddingHorizontal: 16 }]}>
                                <View>
                                    <Text style={styles.itemDate}>{item.date}</Text>
                                    <Text style={styles.itemTime}>{item.time}</Text>
                                </View>
                                {item.isSelected ?
                                    <AntDesign name="caretup" size={16} color="#838393" style={{ marginTop: 6 }} /> :
                                    <AntDesign name="caretdown" size={16} color="#141434" style={{ marginTop: 6 }} />}
                            </TouchableOpacity>
                                    ...
                                    <View>
                                        <View style={styles.itemRow}>
                                            ...
                                            <View>
                                                ...
                                                <Text style={styles.itemContent}>{item.timeAllowance}</Text>
                                            </View>
                                            <View>
                                        ...
                                        <View style={[styles.itemRow, { marginTop: 18 }]}>
                                            <TouchableOpacity onPress={() => onEditPress(item.id)} style={[styles.itemButton, { backgroundColor: '#D00C04' }]}>
                                                <Text style={{ color: '#FFFFFF' }}>Edit</Text>
                                            </TouchableOpacity>
                                            <TouchableOpacity onPress={() => onDeletePress(item.id)} style={[styles.itemButton, { borderWidth: 1, borderColor: '#838393' }]}>
