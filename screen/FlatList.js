...
export default function Fl_List() {
    const [data, setData] = useState([
        {
            ...
            content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur est volutpat id ut cursus venenatis ...',
    ...
    const renderHeader = () => (
        <Text style={styles.namePost}>My Posts</Text>
    )
